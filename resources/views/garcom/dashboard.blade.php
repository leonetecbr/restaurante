        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm d-none container" id="manage-table">
            ...
            <div class="mt-3 d-none" id="btn-manage">
                <div class="d-flex flex-column justify-content-center col-10 col-md-5 mx-auto">
                    ...
                    <button class="btn btn-danger" id="btn-close-bill" data-bs-toggle="modal"
                            data-bs-target="#close-bill">
                        Fechar conta
                    </button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-product" novalidate>
                            <div class="col-9 mx-auto">
                                <ul class="list-group mb-3">
                                    <div id="products-add">
                                        <li class="list-group-item text-muted text-center">Ainda não há produtos para
                                            adicionar nessa mesa!
                                        </li>
                                    </div>
                                    <li class="list-group-item d-flex justify-content-between">
                                        <span>Total</span>
                            ...
                            <div class="col-11 mx-auto d-flex justify-content-between">
                                <div class="col-9 d-flex justify-content-between">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="number" class="form-control" id="add-product-quantity" min="1"
                    ...
                    <form id="form-add-products" method="post" data-action="{{ route('garcom.tables.add', '') }}">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" disabled id="btn-submit-add">Adicionar
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="form-close-bill" novalidate>
                        <div class="modal-body">
                            <div class="col-9 mx-auto">
                                <label for="quantity-people-table" class="form-label">
